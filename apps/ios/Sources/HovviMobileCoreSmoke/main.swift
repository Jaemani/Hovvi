...
bracketedPasteModeScreen.apply("\u{001B}[?25;2004h")
try require(bracketedPasteModeScreen.isCursorVisible, "terminal screen should apply combined private cursor visibility mode")
try require(bracketedPasteModeScreen.isBracketedPasteModeEnabled, "terminal screen should apply combined private bracketed paste mode")
bracketedPasteModeScreen.apply("\u{001B}[?25;2004l")
try require(bracketedPasteModeScreen.isCursorVisible == false, "terminal screen should disable combined private cursor visibility mode")
try require(bracketedPasteModeScreen.isBracketedPasteModeEnabled == false, "terminal screen should disable combined private bracketed paste mode")
...
applicationCursorKeysModeScreen.apply("\u{001B}[?1;7h")
try require(applicationCursorKeysModeScreen.isApplicationCursorKeysModeEnabled, "terminal screen should apply combined private application cursor mode")
try require(applicationCursorKeysModeScreen.isAutoWrapModeEnabled, "terminal screen should apply combined private autowrap mode")
applicationCursorKeysModeScreen.apply("\u{001B}[?1;7l")
try require(applicationCursorKeysModeScreen.isApplicationCursorKeysModeEnabled == false, "terminal screen should disable combined private application cursor mode")
try require(applicationCursorKeysModeScreen.isAutoWrapModeEnabled == false, "terminal screen should disable combined private autowrap mode")
